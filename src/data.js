...
export const DAYS = [
  ...
  },
  {
    ...
    port: 'Wye Creek · The Remarkables', type: 'adventure', typeLabel: 'Naturaleza & lago',
    mapsUrl: 'https://www.google.com/maps/dir/?api=1&origin=-45.03115,168.65901&destination=-45.03247,168.65918&waypoints=-45.13257,168.75789&travelmode=driving',
    activities: [
      {
      ...
      },
      {
        ...
        description: 'De vuelta del sendero cerca del mediodía: almuerzo y tiempo libre en el centro antes del crucero.',
      },
      {
        ...
        description: 'Crucero escénico de 90 minutos por Lake Wakatipu a las 4:00 p.m., saliendo del muelle en 50 Beach Street. Buena hora para la luz de la tarde sobre The Remarkables. Se movió del 20 dic a este día porque allá chocaba con el skydive.',
  ...
  },
  {
    ...
    port: 'Queenstown', type: 'adventure', typeLabel: 'Jet boat & skydive',
    mapsUrl: 'https://www.google.com/maps/dir/?api=1&origin=-45.03115,168.65901&destination=-45.03122,168.65970&waypoints=-44.98713,168.67137&travelmode=driving',
    activities: [
      {
      ...
      {
        name: 'Almuerzo rápido en el centro', travel: true,
        meetingTime: '~12:30 p.m.', meetingPlace: 'Centro de Queenstown', startEnd: '',
        description: 'Almuerzo entre el jet boat y el skydive. Queda poco margen: el jet boat los deja de vuelta cerca de las 12:30 y el check-in del skydive es a la 1:20 p.m., a un par de cuadras.',
      },
      {
        name: 'NZONE Skydive — salto tándem',
        operator: 'NZONE Skydive',
        actionBadge: 'Por reservar',
        meetingTime: '1:20 p.m.', meetingPlace: 'NZONE Skydive, 35 Shotover Street', startEnd: '~3 – 4 h en total',
        description: 'Salto tándem con NZONE. El punto de encuentro es su oficina en 35 Shotover Street, en el centro de Queenstown: ahí se hace el registro y el briefing en video, y de ahí los llevan a la pista privada a ~20 minutos. La experiencia completa toma entre 3 y 4 horas, así que saliendo a la 1:20 p.m. estarían de regreso alrededor de las 4:30 – 5:20 p.m.',
...
export const TODO = [
  ...
  },
  {
    ...
    items: [
      ...
      'Reservar NZONE Skydive — 1:20 p.m. (20 dic)',
      'Reservar Lake Wakatipu cruise 4:00 p.m. (19 dic)',
